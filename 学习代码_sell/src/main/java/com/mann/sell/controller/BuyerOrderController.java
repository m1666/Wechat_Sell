...
import com.mann.sell.converter.OrderForm2OrderDTOConverter;
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String, String>> create(@Valid OrderForm orderForm, BindingResult bindingResult) {
        ...
        OrderDTO orderDTOCreateResult = orderService.create(orderDTO);
        Map<String, String> map = new HashMap<>();
        map.put("orderId", orderDTOCreateResult.getOrderId());
